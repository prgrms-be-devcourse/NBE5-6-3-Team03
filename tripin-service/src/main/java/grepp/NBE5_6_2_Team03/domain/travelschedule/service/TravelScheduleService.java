...
public class TravelScheduleService {
    ...
    public GroupedTravelSchedulesResponse getTravelSchedules(Long travelPlanId) {
        List<TravelSchedule> travelSchedules = travelScheduleRepository.findByTravelPlanId(travelPlanId);
        return GroupedTravelSchedulesResponse.from(travelSchedules);
    }
